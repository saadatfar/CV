...
\vbox{ %
	...
	The vaginal RF technology exposes the inner and outer parts of vagina to high frequency radio waves emitted from safe electrodes with remarkable results. \par
	High-energy and long-lasting RF waves is an effective treatment without any complication that can heat lower layers and muscles with monopolar and multipolar functions without heating the skin or the mucous membrane. \par
	\divider
	}
...
\cvsection{About Me}
Being an engineer, I love building systems that work, no matter if they are devices, software, or even a company or a group of friends. I my view, If you approach everything in a systematic way, you will be able to learn, comprehend, and improve everything faster and more effectively.
