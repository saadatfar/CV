...
\vbox{ %
	...
	\cvskill{Electronics and Power Electronics}{
		Printed Circuit Board (PCB, PCBA) Design (Altium Designer),
		OrCAD,
		LabVIEW,
		PowerSIM,
		MATLAB, Simulink,
	...
	\cvskill{Regulation and Standards}{
		Medical Device Directive (CE) (CE MDD 93/42/eec),
		Low Voltage Directive (CE) LVD 2014/35/EU,
		ISO 13485, ISO 9001,
	...
	\cvskill{Other Skills}{
		Fullstrack Web Development (ASP.Net, Vue.Js, Nuxt, Astro),
		Solidworks,
		Git,
		Docker,
		\LaTeX
