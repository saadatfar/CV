...
\tagline{Senior Power Electronics Engineer and Embedded Software Developer }
...
\vbox{ %
\justifying \noindent
With over 14 years of experience in embedded software development and 12 years in electronics circuit design, 
my expertise encompasses Electronics, Power circuits, Analog circuits, Digital and High-Frequency circuits, Embedded Programming, and PCBA Design. 
As the former CTO of Mersateb Co., a small medical device manufacturer,
I was responsible for both coding and design aspects.
Our team successfully launched six innovative medical devices, solidifying our status as a leading producer in dermatology equipment.
}
\medskip
...
\vbox{ %
	\cvevent
	{Mersateb Co. \link{https://mersateb.com/en}{\faExternalLink*}\titledesc{Medical Device Manufacturing Company}}
	{CTO, CoFounder | Electronics Engineer}
	{2015 -- 2023}{Tehran, Iran \& Istanbul, Turkiye}
	\begin{itemize}
		\item Actively contributing to coding and design, and successfully launched 6 medical device products such as Electrosurgical Plasma, Fractional Micro Needling Radio Frequency, Vaginal Radio Frequency, Carboxy Therapy, and Termo Fractional Device \link{https://mhsaadatfar.dev/download/Catalog/Mersateb.pdf}{(Download Catalogs\faExternalLink*)}.
		\item Designed and developed 20+ PCBAs including high frequency, high voltage, and micro controller boards.
		% \item Designed and developed 6+ software systems including GUIs for the Android and Windows platforms.
		\item Coded 10+ embedded software firmware in C for devices, quality control, and test boards, using ARM, AVR, and FreeRTOS platforms in compliance with IEC 62304 (Medical device software — Software life cycle processes).
		\item Achieved ISO 13485, ISO 9001, Low Voltage Device Certification (LVD 2014/35/EU), and Medical CE Certification (MDD 93/42/EEC).
	\end{itemize}	
	\divider
}
...
\vbox{ %
	\cvevent
	{Faradars \link{https://faradars.org/courses/fvee9406-pcb-design-using-altium-designer}{\faExternalLink*}\titledesc{E-Learning Platform}}
	{Altium Designer PCBA \& OrCad Courses Teacher}
	{2015}{}
	\begin{itemize}
...
\vbox{ %
	\cvsection{Education}
	\cvevent{MSc in Power Electronics and Electrical Machines}{University of Tehran}{2015 -- 2018}{}
...
\vbox{ %
	...
	\cvskill{Other Skills}{
		Fullstack Web Development (ASP.Net, Vue.Js, Astro),
		Solidworks,
		Git,
		Docker,
		\LaTeX
